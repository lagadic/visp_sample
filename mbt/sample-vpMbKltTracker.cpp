...
int main()
{
  ...
  std::shared_ptr<vpDisplay> display = vpDisplayFactory::createDisplay(I, 100, 100, "Mb Klt Tracker");
#else
  vpDisplay *display = vpDisplayFactory::allocateDisplay(I, 100, 100, "Mb Klt Tracker");
#endif
