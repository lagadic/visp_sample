...
int main()
{
  ...
  vpDisplayX display(IMatching, 0, 0, "Image matching and box location detection");
#elif defined(VISP_HAVE_GDI)
  vpDisplayGDI display(IMatching, 0, 0, "Image matching and box location detection");
#else
